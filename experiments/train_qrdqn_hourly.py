...
print(">>> train_qrdqn_hourly.py is running...")
...
# Logging
log_path = "logs/qrdqn_wds_hourly/"
os.makedirs(log_path, exist_ok=True)
...
model.save("models/qrdqn_wds_hourly")
env.save("models/qrdqn_wds_hourly_vecnorm.pkl")

env.close()

print("Training complete. Model saved as models/qrdqn_wds_hourly")
