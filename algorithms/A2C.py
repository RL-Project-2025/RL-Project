...
if __name__ == '__main__':
    ...
    network = ActorCriticNetwork(obs_dim, act_dim)
    ...
    writer = SummaryWriter(log_dir="../logs/a2c")
    ...
    writer.close()
    torch.save(network.state_dict(), "../models/a2c_scratch.pt")
    print(f"\nTraining complete. Model saved to ../models/a2c_scratch.pt")
