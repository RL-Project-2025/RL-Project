...
if __name__ == '__main__':
    ...
    agent = DuellingDQN_Implementation(env, tensorboard_log="../logs/ddqn")
    agent.learn(total_timesteps=200000)
    agent.save("../models/ddqn_scratch.zip")
    print(f"\nTraining complete. Model saved to ../models/ddqn_scratch.zip")
