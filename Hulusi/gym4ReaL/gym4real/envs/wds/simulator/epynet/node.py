...
class Junction(Node):
    ...
    properties = {'head': epanet2.EN_HEAD, 'pressure': epanet2.EN_PRESSURE, 'demand': epanet2.EN_DEMAND, 'demand_deficit': epanet2.EN_DEMANDDEFICIT, 'basedemand': epanet2.EN_BASEDEMAND}
    node_type = "Junction"
